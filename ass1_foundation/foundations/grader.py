...
grader.addManualPart('1d', maxPoints=3, description='strategy for iterated game')
grader.addManualPart('1e', maxPoints=3, description='derive maximum likelihood')
grader.addManualPart('1f', maxPoints=3, description='take gradient')
