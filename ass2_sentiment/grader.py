...
def test3b3():
    ...
    featureExtractor = submission.extractWordFeatures
    weights = submission.learnPredictor(trainExamples, devExamples, featureExtractor, numIters=20, eta=0.01)
    outputErrorAnalysis([("Though slow , a pretty-sincerely-awesomest movie.", 1)], featureExtractor, weights, 'error-analysis')  # Use this to debug
# grader.addBasicPart('3b-3-basic', test3b3, maxPoints=2, maxSeconds=8, description="test classifier on real polarity dev dataset")
...
grader.addHiddenPart('4b-3-basic', test4b3, maxPoints=2, maxSeconds=40, description="make sure the code runs fast enough")
